define(function(require) {
    ...
    var BackupView = BaseView.extend({
        ...
        events: {
          "click #create-backup": "create"
        },

        initialize: function (options) {
            Backup.on('add',    this.add,       this);
            Backup.on('remove', this.remove,    this);
            Backup.on('reset',  this.reset,     this);
            Backup.on('sort',   this.sort,      this);
            Backup.on('change', this.change,    this);
            Backup.on('change:[attribute]', this.change, this);
            Backup.on('destroy',this.destroy,   this);
            Backup.on('request',this.request,   this);
            Backup.on('sync',   this.sync,      this);
            Backup.on('error',  this.error,     this);
            Backup.on('route:[name]', this.route, this);
            Backup.on('all',    this.all,       this);
        },
